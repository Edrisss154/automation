...
import DocumentFlowTree from './DocumentFlowTreeinbox';
        ...
        <>
            ...
            >
                ...
                <ModalBody className="dir-rtl max-h-[80vh] overflow-y-auto p-5 bg-gray-0 dark:bg-gray-900">
                    <h4 className="mb-5 text-gray-700 dark:text-gray-200">پاسخ </h4>
                ...
                <div className="custom-modal-footer bg-gray-50 border-t border-gray-200 dark:bg-gray-900 dark:border-gray-700 px-4 py-3">
                    <div className="flex-1"></div> {/* Spacer برای هل دادن دکمه به سمت راست */}
                    <button
                        onClick={toggle}
                        className="close-button bg-gray-500 hover:bg-gray-600 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200"
                    >
                        بستن
                    </button>
                </div>
