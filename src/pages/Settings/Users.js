...
import { getUsers, getUserById, deleteUser } from '../../api/api';
...
const UserSettings = () => {
    ...
    const handleAddUser = () => {
        setNewUser({ firstName: "", lastName: "", mobile: "", email: "", roles: [] });
        ...
        <div className="max-w-[800px] mx-auto p-5 border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-800 direction-rtl">
            ...
            <div className="w-full mt-8 flex justify-center items-center mb-6">
                <div className="bg-gray-200 dark:bg-gray-700 py-4 px-8 rounded-lg">
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-white">کاربران</h2>
                </div>
            </div>
                        ...
                        <table className="w-full border-collapse bg-white dark:bg-gray-700 rounded-lg overflow-hidden">
                            <thead>
                                <tr className="bg-blue-900 dark:bg-blue-800 text-white">
                                    ...
                                    <th className="p-3 text-right hidden sm:table-cell">موبایل</th>
                                    <th className="p-3 text-right hidden md:table-cell">ایمیل</th>
                                    <th className="p-3 text-right hidden lg:table-cell">سمت</th>
                                </tr>
                            </thead>
                            <tbody>
                                {users.map((user, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="p-3 hidden lg:table-cell">{user.roles.map(role => role.name).join(', ')}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
            ...
            <UserModal
                ...
                toggle={() => setUserModalOpen(!userModalOpen)}
                userData={newUser}
            ...
            <EditUserModal
                ...
                toggle={() => setEditUserModalOpen(!editUserModalOpen)}
                userData={newUser}
                handleSave={handleSaveEditedUser}
            />
