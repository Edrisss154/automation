...
const EditRealPersonModal = ({ isOpen, toggle, userData, handleSave, userId }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        nationalId: userData.national_code || ''
    });
...
export default EditRealPersonModal;