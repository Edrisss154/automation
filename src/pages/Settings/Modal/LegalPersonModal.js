...
import {addContact, getCities, getProvinces, getRoles} from '../../../api/api';
import 'bootstrap/dist/css/bootstrap.min.css';
import Select from "react-select";
import {useNavigate} from "react-router-dom";

const AddLegalPersonModal = ({ isOpen, toggle, handleSave }) => {
    ...
    const handleProvinceChange = async (selectedOption) => {
        ...
        try {
            ...
            console.log(citiesResponse); // بررسی مقادیر citiesResponse
